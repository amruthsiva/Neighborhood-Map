...
- `gmapStyles.css` (Overwrites Bootstrap CSS for custom styling of app)

JS - There are quite a few here and I will try explain as best as possible without becoming too convoluted.
- `knockout-3.4.2.js` (Knockout framework)
- `gmap.js` (Main application file)
- `styles.js` (Contains the styles for the custom Google Maps look)
- `areas.js` (Contains myLocations to populate the map)

HTML - `vizag.html` is where all the magic happens and all the data is binded.

## Features
A Google Maps implemenation that shows you the best places (in my opinion) to visit around vizag, India.
...
## Installation
Clone or download this repo and simply open the vizag.html file and enjoy!
You can make modifications to the locations and add your own in the `js/areas.js` file.
