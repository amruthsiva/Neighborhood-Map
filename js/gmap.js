...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "GWA2GWZFIHPMZE4OD53Q2PSACJXXMJZ2O2Y5SQOQSFVXIU1G";
            clientSecret =
                "LO051JPUSAUAJ15XNM4RDWYWLUC25AS1TYUAHLRBU3TT2SAT";
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(17.734073,83.315904),
            zoom: 15,
            styles: styles
        };
